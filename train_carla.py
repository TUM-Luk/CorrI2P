...
from kitti_pc_img_dataloader_new import carla_pc_img_dataset
# import loss
...
from kitti_debug import get_dataset
...
if __name__=='__main__':
    ...
    parser.add_argument('--data_path', type=str, default='./data', metavar='data_path',
    ...
    logdir=os.path.join(args.save_path, f'{formatted_time}_carla_dist_thres_%0.2f_pos_margin_%0.2f_neg_margin_%0.2f'%(args.dist_thres,args.pos_margin,args.neg_margin,))
    try:
        os.makedirs(logdir)
    except:
        print('mkdir failue')
    ...
    test_dataset = get_dataset(mode='val')
    ...
    for epoch in range(args.epoch):
        for step,data in enumerate(trainloader):
            ...
            loss_desc,dists=desc_loss(img_features_flatten_inline,pc_features_inline,correspondence_mask,pos_margin=args.pos_margin,neg_margin=args.neg_margin, mode='contrastive', bin_score=model.bin_score)
            ...
            # if global_step%args.val_freq==0 and epoch>-1:
