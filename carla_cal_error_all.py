...
if __name__=='__main__':
    ...
    base_path='eval_result/demo15'
    save_path='eval_result/demo15_result'
    ...
    if not multi_thread:
        ...
        for num in range(num_total):
            get_diff(base_path, save_path, dist_thres=args.test_dist_thres,
                    num=num, num_total=num_total)
    else:
        # 多线程
        thres_size=4
